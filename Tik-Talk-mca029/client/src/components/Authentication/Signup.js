  ...
  return (
    <VStack spacing="5px" color="black">
      ...
      <FormControl  color="white" id="email" isRequired>
        ...
        <Input  
          placeholder="Enter Your Email" color={"white"}
      ...
      <FormControl  color="white" id="password" isRequired>
        ...
        <InputGroup>
          ...
          <InputRightElement width="4.5rem">
            <Button h={"1.7rem"} size="sm" color={"black"} onClick={handleClick_1}>
              {show_1 ? "Hide" : "Show"}
            </Button>
          </InputRightElement>
        </InputGroup>
      ...
      <FormControl id="password" isRequired>
        ...
        <InputGroup>
          ...
          />
          <InputRightElement width="4.5rem">
            <Button h={"1.7rem"}  color={"black"} size="sm" onClick={handleClick_2}>
              {show_2 ? "Hide" : "Show"}
            </Button>
          </InputRightElement>
        </InputGroup>
      </FormControl>
      <FormControl  color="white" id="pic">
